...
export default {
    ...
    methods:{
        ...
        subDetailNoImg(){
            ...
            postRequest(curentUrl+"3",pamas).then(data=> {
        ...
        subHallDetail(){
            ...
            uploadFileRequest(curentUrl+"3",this.formDate).then(data=> {
                this.upfileList3=[]
        ...
        subDetail(){
            ...
            switch (this.tableName2) {
                ...
                default:
                    ...
                    uploadFileRequest(curentUr+"3",this.formDate).then(data=> {
                        this.upfileList2=[]
                        console.log("上传的成功返归",data)
                        this.$nextTick(() => {
        ...
        this.$confirm('是否删除?', '提示', {
            ...
            type: 'warning'
                ...
                postRequest(currentUrl+"3",pamas ).then(data=> {
        ...
        deleteRow3(index,rows){
            postRequest(url.hallPictureDelHallPicture+"3", {
                ids:rows[index].id,
                keys:rows[index].pictureUrl
            }).then(data=> {
                    console.log("删除后打印的数据",data)
        ...
        initData(pamas){
            postRequest(url.hotelsGetHotelsList+"3", pamas).then(data=> {
        ...
        initData3(){
            ...
            postRequest(url.hallPictureGetHallPictureList+"3", {
