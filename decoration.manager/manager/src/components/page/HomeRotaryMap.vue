    ...
    <div>
           ...
           <el-table-column
            ...
            show-overflow-tooltip>
                <template    slot-scope="scope">            
                    <div title="点击显示大图" >
                        <img :src="QINIU+scope.row.bannerUrl"    style="width:60px; height:20px" />
                        <el-popover
                        placement="right"
                        trigger="click"
                        >
                            <img :src="QINIU+scope.row.bannerUrl"    style="max-height:400px" />
        ...
        <!-- 分页 -->
          <div class="block" style="overflow:hidden;display:none">
            ...
            prop="bannerLink"
            >
                <el-input type="text"  placeholder="请输入轮播图链接" v-model.number="ruleForm.bannerLink" autocomplete="off">
            ...
            <div style="display:flex">
                 ...
                 <p style="line-height:40px;margin-left:30px">建议图片大小：1900*460</p>
            </div>
...
export default {
    ...
    methods:{
            ...
            this.$refs["ruleForm"].validate((valid) => {
                ...
                if (valid) {
                    ...
                    if(this.submitTag=="add"){
                        curentUrl=url.bannerAddBanner

                    }
                    if(this.submitTag=="change"){
                        console.log("change", this.tableList[this.changeIndex].id,this.tableList[this.changeIndex].bannerUrl)
                        curentUrl=url.bannerUpdBanner
                        this.formDate.append('id', this.tableList[this.changeIndex].id);

                        if(url.qiniuH+this.tableList[this.changeIndex].bannerUrl!=this.$refs.upload.uploadFiles[0].url){
                            this.formDate.append('key', this.tableList[this.changeIndex].bannerUrl);
                        }else{
                    ...
                    this.formDate.append('bannerLink', this.ruleForm.bannerLink);
        ...
        changeRow(index, rows){
            ...
            this.$nextTick(() => {
            this.ruleForm={
                bannerLink : rows[index].bannerLink,
            ...
            this.upfileList=[{url:url.qiniuH+rows[index].bannerUrl}]
        ...
        deletMost(){
            ...
            for(let i=0;i<this.multipleSelection.length;i++){
                ...
                arrPictures.push(this.multipleSelection[i].bannerUrl)
        ...
        initData(pamas){
            postRequest(url.bannerGetBannerList, pamas).then(data=> {
