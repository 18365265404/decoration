...
export default {
    ...
    methods:{
        ...
        subDetailNoImg(){
            ...
            postRequest(curentUrl+"2",pamas).then(data=> {
        ...
        subHallDetail(){
            ...
            uploadFileRequest(curentUrl+"2",this.formDate).then(data=> {
                this.upfileList3=[]
        ...
        this.$confirm('是否删除?', '提示', {
            ...
            type: 'warning'
                ...
                postRequest(currentUrl+"2",pamas ).then(data=> {
        ...
        deleteRow3(index,rows){
            postRequest(url.hallPictureDelHallPicture+"2", {
                ids:rows[index].id,
                keys:rows[index].pictureUrl
            }).then(data=> {
                    console.log("删除后打印的数据",data)
        ...
        initData(pamas){
            postRequest(url.hotelsGetHotelsList+"2", pamas).then(data=> {
        ...
        initData3(){
            ...
            postRequest(url.hallPictureGetHallPictureList+"2", {
