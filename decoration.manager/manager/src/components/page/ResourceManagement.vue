<template>
    ...
    <!-- 批量删除 -->
        ...
        <!-- 自定义表格 -->
        <div style="background:white;color:#666666;font-size:12px;margin-left:2%;margin-right:2%">
            <ul>
                <div style="display:flex; line-height:60px;color:#333333;font-size:14px;background:#EEF1F6">
                        
                        <span style="width:25%; margin-left:20px">资源名称</span>
                        <span style="width:25%;">资源URL</span>
                        <span style="width:25%;">资源排序</span>
                        <div style="width:25%;">操作</div>
                    </div>
                <li style="line-height:40px;" v-for="items in tableList" v-bind:key="items.id">
                    <div style="display:flex;">
                        
                        <h6 style="width:25%; margin-left:20px;font-size:18px">{{items.resourceName}}</h6>
                        <span style="width:25%;">{{items.resourceUrl}}</span>
                        <span style="width:25%;">{{items.resourceSort}}</span>
                        <div style="width:25%">
                            <el-button style="height:30px;margin-top:5px" @click.native.prevent="deleteRow(items.id)"  type="danger">删除</el-button>
                            <el-button style="margin-left:2%;margin-top:5px;height:30px" @click.native.prevent="changeRow(items.id,items.resourceSort)"  type="success">修改</el-button>
                        </div>
                    ...
                    <ul>
                        <li style=" display:flex"  v-for="item in items.subdirectoryList" v-bind:key="item.id">
                            ...
                            <span style="width:25%;">{{item.resourceSort}}</span>
                            <div style="width:25%">
                                <el-button style="margin-top:5px;height:30px" @click.native.prevent="deleteRow(item.id)"  type="danger">删除</el-button>
                                <el-button style="margin-left:2%;margin-top:5px;height:30px" @click.native.prevent="changeRow(item.id,item.resourceSort)"  type="success">修改</el-button>
                            </div>
